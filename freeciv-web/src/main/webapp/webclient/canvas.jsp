...
<image id="map_tiletype_grid" style="display:none;"> <image
	id="borders_image" style="display:none;"> <image
	id="roads_image" style="display:none;">
