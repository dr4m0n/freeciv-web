...
function init_webgl_renderer()
{
  ...
  $.ajax({
    async: false,
    url: (location.hostname == "play.freeciv.org" || location.hostname == "www.freecivweb.org") ? "/javascript/webgl/libs/webgl-client.min.js" : "/javascript/webgl/libs/webgl-client.js",
    dataType: "script"
  });
