		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel-freeciv">
					<p>Shows the number of started new games Freeciv each day in
					...
					<ul>
						...
						<li>Freeciv desktop multiplayer: games reported by
							meta.freeciv.org</li>
		...
		<script>
			...
			try {
				Morris.Line({
					...
					pointSize : 0,
					lineWidth : 1,
					ykeys : [ 'webSinglePlayer', 'webMultiPlayer',
							'webPlayByEmail', 'desktopMultiplayer',
							'webHotseat', 'webSinglePlayer3D' ],
					labels : [ 'Freeciv-web 2D singleplayer',
							'Freeciv-web multiplayer', 'Freeciv-web PBEM',
							'Freeciv desktop multiplayer',
							'Freeciv-web hotseat',
							'Freeciv-web 3D WebGL singleplayer' ]
				});
			} catch (err) {
